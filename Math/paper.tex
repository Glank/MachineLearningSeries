...
Let $s$ be a scalar, $x$ be in $\mathbb{Z}^{+} \cup \{0\}$, and $A$ be
...
Let $x$ be in $\mathbb{Z}^{+} \cup \{0\}$ and let $A$ and $B$ be
...
\end{theorem}
\begin{proof}
Let $|A| = \vec{x} \oplus \vec{y} \oplus \vec{a}$ where $|\vec{x}| = x$ and
$|\vec{y}| = y$. Note that,
\[ |\Tran(A, x)| = \vec{y} \oplus \vec{a} \oplus \vec{x} \]
And,
\[ |\Tran(\Tran(A, x), y)| = \vec{a} \oplus \vec{x} \oplus \vec{y} \]
Also that,
\[ |\Tran(A, x+y)| = \vec{a} \oplus \vec{x} \oplus \vec{y} \]
So $|\Tran(\Tran(A, x), y)| = \Tran(A, x+y)$ which is necessary but not
sufficient for this proof.

To show the elementwise equivalence, let $\bar{x} \in \Dim(\vec{x})$,
$\bar{y} \in \Dim(\vec{y})$, and $\bar{a} \in \Dim(\vec{a})$. Then,
\begin{align*}
  \Tran(\Tran(A, x), y)[\bar{a} \oplus \bar{x} \oplus \bar{y}]
  &= A[\bar{x} \oplus \bar{y} \oplus \bar{a}] \\
  &= \Tran(A, x+y)[\bar{a} \oplus \bar{x} \oplus \bar{y}]
\end{align*}
Which shows that $\Tran(\Tran(A, x), y) = \Tran(A, x+y)$
\end{proof}
