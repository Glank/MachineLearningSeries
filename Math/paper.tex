...
in there or something,'' - Dr. William Tepfenhart 
\end{displayquote}
...
\begin{align}
	...
	&= (S \mmult{0} A)[\bar{a}] \\
\end{align}
Note that step 3 is valid because $\bar{c}$ can only be $\left<\right>$ and
$\left<\right> \oplus \bar{a} = \bar{a}$. So, $sA = S \mmult{0} A$.
