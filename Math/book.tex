...
\section{Multimatrix Hadamard Product}

\begin{displayquote}
TODO
\end{displayquote}

What the hell is a `Hadamard product'? The Hadamar product of two matricies
is how one would actually expect matrix multiplication to work.
