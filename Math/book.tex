...
the real componenet and $F[k,2]$ is the imaginary component. So,
...
there is an associated vector space of multimatrices $R^{\vec{x}}$. And I haven't yet explictly stated that. Need to do
that because I'm pretty sure that's necesary for the shortest path being the one that's orthoganal.
...
That is, $u$ is the closest vector in $f$ to $v$ if and only if it is the orthoganal project of $v$ onto $f$.
